...
<table width="100%" style="width: 100%; table-layout: auto; border-collapse: collapse;">
  ...
  <tbody valign="top">
    ...
    <tr><td><code>--reasoning</code></td><td><code>disabled</code></td><td>启用或关闭 <code>claude_code</code> 与 <code>codex</code> 的推理。默认关闭可显著缩短评测时间，同时通常只会对效果产生轻微影响；更重视任务成功率时可开启推理。</td></tr>
